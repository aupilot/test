...
class Accounts:
    ...
    def account_list(self):
        ...
        url = 'https://apisb.etrade.com/v1/market/optionexpiredate?symbol=AAPL'




        url = "https://apisb.etrade.com/v1/accounts/dBZOKt9xDrtRSAOl4MSiiA/balance?instType=BROKERAGE&realTimeNAV=true"

        # Make API call for GET request
        # response = self.session.get(url, header_auth=True, params={"overrideSymbolCount": True},  headers={"consumerkey": 'a29d6b55ef04f5fd7f0237134f2b4f2a'})
